...
const HomeFeature: FC = () => {
  return (
    <Box id="agen" sx={{ py: { xs: 10, md: 14 }, backgroundColor: 'background.default' }}>
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/head-content.png" width={650} height={678} quality={97} alt="Feature img" />
              {/* <Box
                sx={{
                  position: 'absolute',
                  top: -36,
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              <Typography variant="h4">Komunitas agen dengan jaringan luas dan terpercaya</Typography>
            </Typography>

            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Dapatkan penghasilan tambahan dengan menjadi agen/marketer di IniKode bootcamp
            </Typography>
